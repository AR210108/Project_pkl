...
class DataProjectController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'status' => 'required|string|in:Pending,Proses,Selesai,Dalam Pengerjaan',
            'penanggung_jawab_id' => 'nullable|exists:users,id',
        ], [
            'penanggung_jawab_id.exists' => 'Manager Divisi yang dipilih tidak valid',
            'deadline.date' => 'Format deadline tidak valid',
            'harga.numeric' => 'Harga harus berupa angka',
            'progres.integer' => 'Progres harus berupa angka antara 0-100',
            'progres.min' => 'Progres minimal 0%',
            'progres.max' => 'Progres maksimal 100%',
            'status.in' => 'Status harus: Pending, Proses, Selesai, atau Dalam Pengerjaan',
        ]);
