        ...
        try {
            ...
            $transformedTasksFromKaryawan = $tasksFromKaryawan->map(function($task) {
                ...
                return [
                    ...
                    'karyawan_id'       => $task->karyawan_id,
                    'assignee_name'     => $task->karyawan->name ?? 'Unknown',
                    'judul'             => $task->judul,
                    'nama_tugas'        => $task->nama_tugas,
                    'deskripsi'         => $task->deskripsi,
                    'deadline'          => $task->deadline ? $task->deadline->format('Y-m-d H:i:s') : null,
            ...
            $allTasks = $transformedTasks->merge($transformedTasksFromKaryawan)->sortByDesc('created_at')->values();
        ...
        try {
            ...
            $taskData = [
                ...
                'judul'             => $validated['judul'],
                    'nama_tugas'        => $validated['nama_tugas'] ?? $validated['judul'], // gunakan nama_tugas jika diberikan
            ...
            // Log full saved task for debugging nama_tugas issues
            Log::info('Created task data full:', $task->toArray());
