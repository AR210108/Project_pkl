...
<head>
    ...
    <style>
        ...
        .sidebar-logo {
            height: 3rem;
            /* 48px, sesuai dengan tinggi header dikurangi padding */
            width: auto;
            object-fit: contain;
        }
    </style>
...
<body class="bg-gray-100">
    ...
    <!-- Sidebar -->
    <aside id="sidebar"
        class="sidebar-fixed w-64 bg-white sidebar-transition transform translate-x-full md:translate-x-0 right-0 md:left-0 shadow">

        <!-- Header -->
        <div class="h-20 flex items-center justify-center border-b px-4">
            <img src="{{ asset('images/logo_inovindo.jpg') }}" alt="Inovindo Logo" class="h-12 w-auto object-contain">
        </div>

        <!-- Menu -->
        <nav class="flex-1 px-4 py-6 space-y-1">
            <a class="nav-item flex items-center gap-3 px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 rounded"
                href="/general_manajer/home">
                <span class="material-icons">home</span>
                <span>Beranda</span>
            </a>
            <a class="nav-item flex items-center gap-3 px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 rounded"
                href="/general_manajer/data_karyawan">
                <span class="material-icons">group</span>
                <span>Data Karyawan</span>
            </a>
            <a class="nav-item flex items-center gap-3 px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 rounded"
                href="/general_manajer/tim_dan_divisi">
                <span class="material-icons">business</span>
                <span>Manajemen Tim & Divisi</span>
            </a>
            <a class="nav-item flex items-center gap-3 px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 rounded"
                href="/general_manajer/layanan">
                <span class="material-icons">miscellaneous_services</span>
                <span>Data Layanan</span>
            </a>
            <a class="nav-item flex items-center gap-3 px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 rounded"
                href="/general_manajer/data_project">
                <span class="material-icons">receipt_long</span>
                <span>Data Project</span>
            </a>
            <a class="nav-item flex items-center gap-3 px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 rounded"
                href="/general_manajer/kelola-tugas">
                <span class="material-icons">task_alt</span>
                <span>Kelola Tugas</span>
            </a>
            <a class="nav-item flex items-center gap-3 px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 rounded"
                href="/general_manajer/kelola_absen">
