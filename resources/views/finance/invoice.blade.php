...
<script>
        tailwind.config = {
            ...
            theme: {
                extend: {
                    colors: {
                        primary: "#111827", // Gray-900 as primary brand color
                        "background-light": "#ffffff",
                        "background-dark": "#111827",
                        "surface-light": "#e5e7eb", // gray-200
                        "surface-dark": "#1f2937", // gray-800
                        "accent-light": "#d1d5db", // gray-300
...
<aside class="w-64 bg-surface-light dark:bg-surface-dark flex flex-col justify-between p-6 flex-shrink-0 z-10 relative shadow-none">
<div>
<div class="mb-12">
<h1 class="text-4xl font-extrabold tracking-tight text-black dark:text-white">Brand</h1>
</div>
<nav class="space-y-4">
<a class="flex items-center gap-4 text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white font-medium group transition-colors" href="#">
<span class="material-icons-outlined text-2xl group-hover:scale-105 transition-transform">home</span>
                        Beranda
                    </a>
<a class="flex items-center gap-4 text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white font-medium group transition-colors" href="#">
<span class="material-icons-outlined text-2xl group-hover:scale-105 transition-transform">account_balance_wallet</span>
                        Pemasukan
                    </a>
<a class="flex items-center gap-4 text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white font-medium group transition-colors" href="#">
<span class="material-icons-outlined text-2xl group-hover:scale-105 transition-transform">payments</span>
                        Pengeluaran
                    </a>
<a class="flex items-center gap-4 text-black dark:text-white font-bold group transition-colors" href="#">
<span class="material-icons-outlined text-2xl group-hover:scale-105 transition-transform">receipt</span>
                        Invoice
                    </a>
<a class="flex items-center gap-4 text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white font-medium group transition-colors" href="#">
<span class="material-icons-outlined text-2xl group-hover:scale-105 transition-transform">receipt_long</span>
                        Kwitansi
                    </a>
<a class="flex items-center gap-4 text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white font-medium group transition-colors" href="#">
<span class="material-icons-outlined text-2xl group-hover:scale-105 transition-transform">menu_book</span>
                        Pembayaran Layanan
                    </a>
<a class="flex items-center gap-4 text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white font-medium group transition-colors" href="#">
<span class="material-icons-outlined text-2xl group-hover:scale-105 transition-transform">people</span>
                        Data Karyawan
                    </a>
</nav>
</div>
<div class="mt-8">
<a class="flex items-center gap-4 text-black dark:text-white font-bold text-lg hover:opacity-75 transition-opacity" href="#">
<span class="material-icons-outlined text-2xl transform rotate-180">logout</span>
                    Log Out
                </a>
</div>
</aside>
...
<input class="w-full bg-gray-300 dark:bg-gray-700 text-black dark:text-white placeholder-black dark:placeholder-gray-300 rounded-full py-3 pl-12 pr-4 focus:outline-none focus:ring-2 focus:ring-gray-500 dark:focus:ring-gray-500 font-bold border-none" placeholder="Search..." type="text"/>
</div>
