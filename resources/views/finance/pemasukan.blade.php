...
<body class="font-display bg-background-light text-text-light">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                    ...
                    <div class="flex flex-wrap gap-3 w-full md:w-auto">
                        <div class="relative w-full md:w-1/3">
                            ...
                            <input id="finance-search" class="w-full pl-10 pr-4 py-2 bg-white border border-border-light rounded-lg focus:ring-2 focus:ring-primary focus:border-primary form-input" placeholder="Cari nama, kategori, atau deskripsi..." type="text" />
                        </div>
                        <div class="relative">
                ...
                <div class="panel">
                    <div class="panel-header">
                        ...
                        <div class="flex items-center gap-2">
                            <span class="text-sm text-text-muted-light">Total: <span id="totalCount" class="font-semibold text-text-light">20</span> transaksi</span>
                        </div>
                    </div>
                ...
                <form class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="date" class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-primary">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Tipe Transaksi</label>
                            <select id="transaction-type" class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-primary" onchange="updateCategoryOptions()">
                        ...
                        <div>
                            ...
                            <select id="transaction-category" class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-primary">
                                <option value="">Pilih Kategori</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Nama</label>
                            <input type="text" class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="Nama Transaksi">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Jumlah</label>
                            <input type="text" class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="Jumlah">
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Deskripsi</label>
                            <textarea class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-primary" rows="3" placeholder="Deskripsi Transaksi"></textarea>
                        </div>
                    </div>
    ...
    <div id="transactionDetailModal" class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
            ...
            <div class="p-6">
                ...
                <div class="bg-gray-50 rounded-lg p-4 sm:p-6 mb-4 sm:mb-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                        <div>
                            <h5 class="font-semibold text-text-light mb-2 sm:mb-3 text-sm sm:text-base">Informasi Transaksi</h5>
                            <div class="space-y-2">
                                ...
                                <div class="flex flex-col sm:flex-row">
                                    ...
                                    <span id="detail-date" class="text-xs sm:text-sm text-text-light font-medium"></span>
                                </div>
                                <div class="flex flex-col sm:flex-row">
                                    <span class="text-xs sm:text-sm text-text-muted-light sm:w-32">Tipe:</span>
                                    <span id="detail-type" class="text-xs sm:text-sm text-text-light font-medium"></span>
                                </div>
                                <div class="flex flex-col sm:flex-row">
                                    <span class="text-xs sm:text-sm text-text-muted-light sm:w-32">Kategori:</span>
                                    <span id="detail-category" class="text-xs sm:text-sm text-text-light font-medium"></span>
                                </div>
                            </div>
                        </div>
                        <div>
                            <h5 class="font-semibold text-text-light mb-2 sm:mb-3 text-sm sm:text-base">Detail Pembayaran</h5>
                            <div class="space-y-2">
                                <div class="flex flex-col sm:flex-row">
                                    <span class="text-xs sm:text-sm text-text-muted-light sm:w-32">Nama:</span>
                                    <span id="detail-name" class="text-xs sm:text-sm text-text-light font-medium"></span>
                                </div>
                                <div class="flex flex-col sm:flex-row">
                                    <span class="text-xs sm:text-sm text-text-muted-light sm:w-32">Jumlah:</span>
                                    <span id="detail-amount" class="text-xs sm:text-sm text-text-light font-medium"></span>
                                </div>
                                <div class="flex flex-col sm:flex-row">
                                    <span class="text-xs sm:text-sm text-text-muted-light sm:w-32">Metode:</span>
                                    <span id="detail-method" class="text-xs sm:text-sm text-text-light font-medium"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-col sm:flex-row justify-center sm:justify-end gap-2 sm:gap-3 mt-4 sm:mt-6">
                    <button onclick="printTransaction()" class="px-4 py-2 btn-primary rounded-lg flex items-center gap-2">
                        <span class="material-icons-outlined">print</span>
                        <span>Cetak</span>
                    </button>
                    <button onclick="downloadTransaction()" class="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors flex items-center gap-2">
                        <span class="material-icons-outlined">download</span>
                        <span>Download</span>
                    </button>
                    <button onclick="closeTransactionDetailModal()" class="px-4 py-2 btn-secondary rounded-lg flex items-center gap-2">
                        <span class="material-icons-outlined">close</span>
                        <span>Tutup</span>
                    </button>
                </div>
    ...
    <script>
        // Data keuangan
        const financeData = [
            { no: 1, tanggal: "2023-01-05", nama: "Gaji Bulanan", kategori: "salary", deskripsi: "Gaji bulan Januari 2023", jumlah: "Rp 15.000.000", tipe: "income" },
            { no: 2, tanggal: "2023-01-10", nama: "Proyek Website", kategori: "project", deskripsi: "Pembuatan website untuk PT. Teknologi Maju", jumlah: "Rp 8.500.000", tipe: "income" },
            { no: 3, tanggal: "2023-01-12", nama: "Sewa Kantor", kategori: "office", deskripsi: "Pembayaran sewa kantor bulan Januari", jumlah: "Rp 5.000.000", tipe: "expense" },
            { no: 4, tanggal: "2023-01-15", nama: "Investasi Saham", kategori: "investment", deskripsi: "Dividen saham PT. Bank Central Asia", jumlah: "Rp 2.500.000", tipe: "income" },
            { no: 5, tanggal: "2023-01-18", nama: "Iklan Online", kategori: "marketing", deskripsi: "Biaya iklan Google Ads dan Facebook Ads", jumlah: "Rp 3.200.000", tipe: "expense" },
            { no: 6, tanggal: "2023-01-20", nama: "Proyek Aplikasi", kategori: "project", deskripsi: "Pengembangan aplikasi mobile untuk CV. Digital Solusi", jumlah: "Rp 12.000.000", tipe: "income" },
            { no: 7, tanggal: "2023-01-22", nama: "Listrik dan Air", kategori: "utilities", deskripsi: "Pembayaran tagihan listrik dan air bulan Januari", jumlah: "Rp 2.100.000", tipe: "expense" },
            { no: 8, tanggal: "2023-01-25", nama: "Bonus Proyek", kategori: "project", deskripsi: "Bonus dari proyek selesai lebih awal", jumlah: "Rp 3.000.000", tipe: "income" },
            { no: 9, tanggal: "2023-01-28", nama: "Internet dan Telepon", kategori: "utilities", deskripsi: "Pembayaran internet dan telepon kantor", jumlah: "Rp 1.500.000", tipe: "expense" },
            { no: 10, tanggal: "2023-02-01", nama: "Gaji Bulanan", kategori: "salary", deskripsi: "Gaji bulan Februari 2023", jumlah: "Rp 15.000.000", tipe: "income" },
            { no: 11, tanggal: "2023-02-05", nama: "Proyek UI/UX", kategori: "project", deskripsi: "Desain UI/UX untuk aplikasi e-commerce", jumlah: "Rp 7.500.000", tipe: "income" },
            { no: 12, tanggal: "2023-02-08", nama: " ATK dan Perlengkapan", kategori: "office", deskripsi: "Pembelian alat tulis kantor dan perlengkapan", jumlah: "Rp 850.000", tipe: "expense" },
            { no: 13, tanggal: "2023-02-12", nama: "Investasi Reksadana", kategori: "investment", deskripsi: "Keuntungan dari reksadana pasar uang", jumlah: "Rp 1.200.000", tipe: "income" },
            { no: 14, tanggal: "2023-02-15", nama: "Acara Team Building", kategori: "office", deskripsi: "Biaya acara team building karyawan", jumlah: "Rp 4.500.000", tipe: "expense" },
            { no: 15, tanggal: "2023-02-18", nama: "Konsultasi IT", kategori: "project", deskripsi: "Jasa konsultasi IT untuk PT. Inovasi Nusantara", jumlah: "Rp 5.500.000", tipe: "income" },
            { no: 16, tanggal: "2023-02-20", nama: "Asuransi Kesehatan", kategori: "office", deskripsi: "Pembayaran premi asuransi kesehatan karyawan", jumlah: "Rp 3.000.000", tipe: "expense" },
            { no: 17, tanggal: "2023-02-22", nama: "Royalti Software", kategori: "investment", deskripsi: "Pendapatan royalti dari software yang dikembangkan", jumlah: "Rp 2.000.000", tipe: "income" },
            { no: 18, tanggal: "2023-02-25", nama: "Maintenance Server", kategori: "utilities", deskripsi: "Biaya maintenance server dan hosting", jumlah: "Rp 1.200.000", tipe: "expense" },
            { no: 19, tanggal: "2023-02-28", nama: "Workshop Digital Marketing", kategori: "marketing", deskripsi: "Biaya workshop digital marketing untuk tim", jumlah: "Rp 2.500.000", tipe: "expense" },
            { no: 20, tanggal: "2023-03-01", nama: "Gaji Bulanan", kategori: "salary", deskripsi: "Gaji bulan Maret 2023", jumlah: "Rp 15.000.000", tipe: "income" }
        ];
