...
<head>
    ...
    <style>
        ...
        .nav-item.active {
            ...
            color: #111827 !important; /* Warna teks yang lebih gelap, dengan !important */
            font-weight: 600 !important; /* Menebalkan teks, dengan !important */
        }
        ...
        .sidebar-fixed {
            position: fixed;
            top: 0;
            width: 256px !important; /* Lebar tetap, dengan !important */
            min-width: 256px !important; /* Lebar minimum, dengan !important */
            max-width: 256px !important; /* Lebar maksimum, dengan !important */
            height: 100vh;
            overflow-y: auto;
            z-index: 40;
            flex-shrink: 0 !important; /* Mencegah sidebar mengecil, dengan !important */
        }
        ...
        @media (min-width: 768px) {
            .main-content {
                margin-left: 256px !important; /* Lebar sidebar yang tetap, dengan !important */
                width: calc(100% - 256px) !important; /* Lebar konten utama disesuaikan, dengan !important */
            }
        }
        ...
        .sidebar-text {
            font-size: 0.875rem !important; /* 14px, dengan !important */
            line-height: 1.25rem !important; /* 20px, dengan !important */
            font-weight: 500 !important; /* Medium, dengan !important */
            color: #374151 !important; /* Gray-700, dengan !important */
        }
        
        .sidebar-title {
            font-size: 1.5rem !important; /* 24px, dengan !important */
            line-height: 2rem !important; /* 32px, dengan !important */
            font-weight: 700 !important; /* Bold, dengan !important */
            color: #1f2937 !important; /* Gray-800, dengan !important */
        }
        
        /* Memastikan ikon tidak berubah ukurannya */
        .sidebar-icon {
            font-size: 1.25rem !important; /* 20px, dengan !important */
            width: 1.25rem !important; /* 20px, dengan !important */
            height: 1.25rem !important; /* 20px, dengan !important */
        }
        
        /* Memastikan padding dan margin tidak berubah */
        .sidebar-nav-item {
            padding: 0.625rem 1rem !important; /* 10px 16px, dengan !important */
        }
        
        .sidebar-header {
            height: 5rem !important; /* 80px, dengan !important */
            min-height: 5rem !important; /* 80px, dengan !important */
            max-height: 5rem !important; /* 80px, dengan !important */
        }
        
        .sidebar-footer {
            padding: 1.5rem 1rem !important; /* 24px 16px, dengan !important */
        }
    </style>
</head>
    ...
    <!-- Container utama aplikasi -->
        ...
        <aside id="sidebar" class="sidebar-fixed bg-white flex flex-col sidebar-transition transform translate-x-full md:translate-x-0 right-0 md:left-0 md:right-auto shadow-lg">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                <!-- Menu Beranda -->
                <a class="nav-item flex items-center gap-3 sidebar-nav-item text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-lg transition-colors" href="/admin" data-page="admin">
                    <span class="material-icons sidebar-icon">home</span>
                    <span class="sidebar-text">Beranda</span>
                </a>

                <!-- Menu Data User -->
                <a class="nav-item flex items-center gap-3 sidebar-nav-item text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-lg transition-colors" href="/data_user" data-page="data_user">
                    <span class="material-icons sidebar-icon">person</span>
                    <span class="sidebar-text">Data User</span>
                </a>

                <!-- Menu Data Karyawan -->
                <a class="nav-item flex items-center gap-3 sidebar-nav-item text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-lg transition-colors" href="/admin/data_karyawan" data-page="data_karyawan">
                    <span class="material-icons sidebar-icon">group</span>
                    <span class="sidebar-text">Data Karyawan</span>
                </a>

                <!-- Menu Data Layanan -->
                <a class="nav-item flex items-center gap-3 sidebar-nav-item text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-lg transition-colors" href="/admin/layanan" data-page="layanan">
                ...
                <div class="relative">
                    <button class="nav-item flex items-center gap-3 sidebar-nav-item text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-lg transition-colors w-full text-left" 
                        ...
                        <span class="material-icons sidebar-icon ml-auto transition-transform duration-200" id="surat-kerjasama-icon">expand_more</span>
                    </button>
                    ...
                    <div id="surat-kerjasama-dropdown" class="pl-6 mt-1 space-y-1 hidden">
                        ...
                        <a class="nav-item flex items-center gap-3 sidebar-nav-item text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-lg transition-colors" 
                            href="/list_surat" data-page="list_surat">
                ...
                <div class="relative">
                    <button class="nav-item flex items-center gap-3 sidebar-nav-item text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-lg transition-colors w-full text-left" 
                        ...
                        <span class="material-icons sidebar-icon ml-auto transition-transform duration-200" id="invoice-kwitansi-icon">expand_more</span>
                    </button>
