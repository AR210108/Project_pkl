...
<div class="max-w-5xl mx-auto bg-white">
    ...
    <div class="border-b border-gray-200 px-8 py-6">
        <h1 class="text-3xl font-light tracking-tight text-gray-900 flex items-center">
            <i class="fas fa-file-pen mr-3 text-gray-700"></i>
            Edit Surat Kerjasama
        </h1>
        <p class="text-gray-600 mt-2">Perbarui detail surat kerjasama yang sudah ada.</p>
    </div>

    <!-- Body Form -->
    <form method="POST" action="{{ route('admin.surat_kerjasama.update', $surat->id) }}" class="p-8">
        @csrf
        @method('PUT')
        ...
        <div class="border-t border-gray-200 pt-8 mt-8">
            ...
            <p class="text-sm text-gray-600 mb-4">Buat tanda tangan baru di bawah ini (jika ingin mengganti):</p>
        ...
        <div class="flex justify-end items-center gap-4 border-t border-gray-200 pt-8 mt-8">
            <a href="{{ route('admin.surat_kerjasama.index', $surat->id) }}"
