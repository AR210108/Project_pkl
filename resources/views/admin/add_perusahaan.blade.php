            ...
            <div class="p-6">
                ...
                <form action="{{ route('admin.perusahaan.store') }}" method="POST" id="tambahPerusahaanForm" class="space-y-4" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <input type="number" name="jumlah_kerjasama" min="0" step="1" class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="0">
                    </div>
            ...
            <div class="p-6">
                ...
                <form method="POST" action="{{ route('admin.perusahaan.update', '') }}" id="editPerusahaanForm" class="space-y-4" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Jumlah Kerjasama</label>
                            <input type="number" id="editJumlahKerjasama" name="jumlah_kerjasama" min="0" step="1" class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="0">
                        </div>
                    </div>
                    <div class="flex justify-end gap-2 mt-6">
