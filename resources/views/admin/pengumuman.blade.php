...
<body class="font-display bg-background-light text-text-light">
                ...
                <div class="panel">
                    <div class="panel-header">
                        ...
                        <div class="flex items-center gap-2">
                            <span class="text-sm text-text-muted-light">Total: <span id="totalCount" class="font-semibold text-text-light">0</span> pengumuman</span>
                        </div>
                    </div>
    ...
    <script>
                ...
                if (data.data && data.data.length > 0) {
                    ...
                    data.data.forEach((pengumuman, index) => {
                        ...
                        if (pengumuman.lampiran) {
                            lampiranDisplay = `<a class="text-primary hover:underline" href="${pengumuman.lampiran_url}" target="_blank">${pengumuman.lampiran}</a>`;
                        }
                        ...
                        card.className = 'pengumuman-card bg-white rounded-lg border border-border-light p-4 shadow-sm';
        ...
        function getFilteredRows() {
            return Array.from(document.querySelectorAll('.pengumuman-row')).filter(row => !row.classList.contains('hidden-by-filter'));
        }
        
        function getFilteredCards() {
            return Array.from(document.querySelectorAll('.pengumuman-card')).filter(card => !card.classList.contains('hidden-by-filter'));
        }
