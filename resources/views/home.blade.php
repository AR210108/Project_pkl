...
<head>
   ...
   =============================== */
        ...
        .hero-title {
            opacity: 0;
            animation: heroTitleFade 0.9s ease-out forwards;
        ...
        .hero-desc {
            opacity: 0;
            animation: heroDescUp 0.9s ease-out forwards;
            animation-delay: 0.3;
        }

        @keyframes heroDescUp {
            from {
                opacity: 0;
        ...
        .hero-btn {
            opacity: 0;
            animation:
                heroBtnEnter 0.9s cubic-bezier(0.34, 1.56, 0.64, 1) forwards,
                heroBtnFloat 2s ease-in-out infinite;
            animation-delay: 0.6s, 1.6s;
            /* float mulai setelah enter selesai */
...
<body class="bg-background-light text-text-light">
    ...
    <header id="header" class="sticky-header">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-6">
            <div class="flex justify-between items-center">
                ...
                <nav
                    class="hidden lg:flex items-center space-x-2 md:space-x-4 absolute left-1/2 transform -translate-x-1/2">
                    <a class="nav-link text-xs md:text-sm font-medium text-gray-700 active" href="#beranda"
                        data-section="beranda">Beranda</a>
                    <a class="nav-link text-xs md:text-sm font-medium text-gray-700" href="#layanan"
                        data-section="layanan">Layanan</a>
                    <a class="nav-link text-xs md:text-sm font-medium text-gray-700" href="#tentang"
                        data-section="tentang">Tentang</a>
                    <a class="nav-link text-xs md:text-sm font-medium text-gray-700" href="#portofolio"
                        data-section="portofolio">Portofolio</a>
                    <a class="nav-link text-xs md:text-sm font-medium text-gray-700" href="#artikel"
                        data-section="artikel">Artikel</a>
                    <a class="nav-link text-xs md:text-sm font-medium text-gray-700" href="#kontak"
                ...
                <button id="mobileMenuBtn"
                    class="lg:hidden flex flex flex-col justify-center items-center w-8 h-8 hamburger">
    ...
    <main class="main-content">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <section id="beranda" class="hero-bg rounded-2xl shadow-lg relative overflow-hidden
           min-h-[60vh] md:min-h-[70vh] flex items-center justify-center text-center">
                <div class="hero-overlay"></div>

                <div class="relative z-10 px-4 sm:px-6 md:px-8">
                    <h1 class="hero-title text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-4">
                        <span class="hero-title-shine">DIGITAL AGENCY</span>
                    </h1>
                    ...
                    <div class="gradient-subtle p-6 md:p-8 lg:p-12 rounded-2xl shadow-sm" data-aos="fade-up">
                        ...
                        <div id="layananContainer" class="mb-8 md:mb-10">
                            @if($layanans->isNotEmpty())
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-4 md:mb-6">
                                    @foreach($layanans->take(4) as $index => $layanan)
                                        <div class="service-card bg-card-light p-3 md:p-4 rounded-xl flex flex-col shadow-sm border border-border-light"
                                            ...
                                            <div
                                                class="relative pt-[60%] bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg mb-3 overflow-hidden image-container">
                                                @if($layanan->harga)
                                                    <span
                                                        class="absolute top-2 right-2 bg-white/80 backdrop-blur-sm text-black text-xs font-semibold px-2 py-1 rounded-full z-10">
                                                        Rp {{ number_format($layanan->harga, 0, ',', '.') }}
                                                    </span>
                                                @endif
                                                @if($layanan->foto)
                                                    <img src="{{ Storage::url($layanan->foto) }}" alt="{{ $layanan->nama_layanan }}"
                                            ...
                                            <h3 class="font-bold text-white mb-1 text-xs md:text-sm">
                                                {{ $layanan->nama_layanan ?? 'Layanan ' . $loop->iteration }}
                                            </h3>
                                            <p class="service-description text-xs text-gray-300">
                                                {{ $layanan->deskripsi ?? 'Deskripsi untuk layanan ' . $loop->iteration . '. Ini adalah contoh deskripsi yang berbeda untuk setiap layanan.' }}
                                            </p>
                                ...
                                @if($remainingLayanans->isNotEmpty())
                                                ...
                                                <div class="service-card bg-card-light p-3 md:p-4 rounded-xl flex flex-col shadow-sm border border-border-light"
                                                    ...
                                                    <div
                                                        ...
                                                        @else
                                                            <div class="absolute inset-0 flex items-center justify-center text-white">
                                                                <span
                                                                    class="text-3xl md:text-4xl font-bold">{{ $loop->iteration + 4 }}</span>
                                                            </div>
                                                        @endif
                                                    </div>
                                                    <h3 class="font-bold text-white mb-1 text-xs md:text-sm">
                                                        {{ $layanan->nama_layanan ?? 'Layanan ' . ($loop->iteration + 4) }}
                                                    </h3>
                                                    <p class="service-description text-xs text-gray-300">
                                                        {{ $layanan->deskripsi ?? 'Deskripsi untuk layanan ' . ($loop->iteration + 4) . '. Ini adalah contoh deskripsi yang berbeda untuk setiap layanan.' }}
                                                    </p>
                                                    <button class="service-detail-btn mt-2">
                                                        Lihat Detail
                                                        <span class="material-icons-outlined">arrow_forward</span>
                                    ...
                                    <div id="scrollIndicator" class="layanan-scroll-indicator hidden md:flex"
                                        style="display: none;">
                                        <span>
                                ...
                                <div class="flex gap-3" style="width: max-content;">
                                    @foreach($layanans as $index => $layanan)
                                        <div class="service-card bg-card-light p-3 md:p-4 rounded-xl flex flex-col w-56 flex-shrink-0 shadow-sm border border-border-light"
                                            ...
                                            <h3 class="font-bold text-white mb-1 text-xs md:text-sm">
                                                {{ $layanan->nama_layanan ?? 'Layanan ' . ($index + 1) }}
                                            </h3>
                                            <p class="service-description text-xs text-gray-300">
                                                {{ $layanan->deskripsi ?? 'Deskripsi untuk layanan ' . ($index + 1) . '. Ini adalah contoh deskripsi yang berbeda untuk setiap layanan.' }}
                                            </p>
                                            <button class="service-detail-btn mt-2">
                                                Lihat Detail
                                                <span class="material-icons-outlined">arrow_forward</span>
                        ...
                        @if($layanans->count() > 4)
                            <div class="hidden md:flex justify-center">
                                <button id="layananToggleBtn"
                                    class="btn-primary bg-black text-white font-medium py-2 md:py-3 px-6 md:px-8 rounded-lg flex items-center">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <section class="py-8 md:py-12 lg:py-24 text-center max-w-3xl mx-auto" id="tentang">
                    ...
                    <p class="text-gray-700 leading-relaxed text-sm md:text-base about-description" data-aos="fade-up"
                        data-aos-delay="100">Kami digital agency adalah perusahaan
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-16">
                        <div class="contact-card" data-aos="fade-right">
                            ...
                            <div class="contact-item">
                                ...
                                <div class="contact-text">
                                    ...
                                    <div class="contact-value contact-address text-sm md:text-base">Jl. Batusari Komplek
                                        Buana Citra Ciwastra No.D-3, Buahbatu, Kec. Bojongsoang, Kabupaten Bandung, Jawa
                                        Barat 40287</div>
                                </div>
                            </div>
                            <div class="contact-item">
                                ...
                                <div class="contact-text">
                                    ...
                                    <div class="contact-value contact-email text-sm md:text-base">inovindocorp@gmail.com
                                    </div>
                                </div>
                            </div>
                            <div class="contact-item">
                                ...
                                <div class="contact-text">
                                    ...
                                    <div class="contact-value contact-phone text-sm md:text-base">+62 817 - 251 - 196
                                    </div>
                                </div>
                            </div>
                        </div>
                        <form class="space-y-4 md:space-y-6" id="contactForm" data-aos="fade-left">
                            <div>
                                ...
                                <input
                                    class="w-full bg-white border-gray-300 rounded-lg py-2 md:py-3 px-3 md:px-4 focus:ring-2 focus:ring-black focus:ring-black focus:border-black text-black shadow-sm form-input text-sm md:text-base"
                                    id="name" name="name" placeholder="Nama Anda" type="text" required />
                            </div>
                            <div>
                                <label class="sr-only" for="email">Email</label>
                                <input
                                    class="w-full bg-white border-gray-300 rounded-lg py-2 md:py-3 px-3 md:px-4 focus:ring-2 focus:ring-black focus:ring-black focus:border-black text-black shadow-sm form-input text-sm md:text-base"
                                    id="email" name="email" placeholder="Email Anda" type="email" required />
                            </div>
                            <div>
                                <label class="sr-only" for="message">Message</label>
                                <textarea
                                    class="w-full bg-white border-gray-300 rounded-lg py-2 md:py-3 px-3 md:px-4 focus:ring-2 focus:ring-black focus:ring-black focus:border-black text-black shadow-sm form-input text-sm md:text-base"
                                    id="message" name="message" placeholder="Pesan Anda" rows="6" required></textarea>
                            </div>
                            <button
                                class="w-full btn-primary bg-black text-white font-medium py-2 md:py-3 px-6 md:px-8 rounded-lg text-sm md:text-base"
        ...
        <div class="modal-content">
            ...
            <div class="p-4 md:p-6">
                ...
                <div id="modalImageContainer"
                    class="aspect-video bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg mb-4 md:mb-6 overflow-hidden">
    ...
    <div id="layananModal" class="modal">
        <div class="modal-content">
            ...
            <div class="p-4 md:p-6">
                ...
                <div id="layananModalImageContainer"
                    class="aspect-video bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg mb-4 md:mb-6 overflow-hidden">
 ...
 class="fixed top-4 right-4 bg-white rounded-lg shadow-lg
        p-3 md:p-4 max-w-sm
